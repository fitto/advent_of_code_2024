...
#             # dup_val = [item for item, count in counter.items() if count > 1]
#
#             count_dict = Counter(all_perimeter_places)
#             dupes = {item: count for item, count in count_dict.items() if count > 1}
#
#             addition = 0
...
#                     addition += 1
#
#             all_perimeter_places = list(set(x for x in all_perimeter_places))
...
#                     found_walls_no += 1
#
#         return found_walls_no + addition
#
...
#
#
# this_place = read_file('../data/2/23.txt')
